  ...
  return (
    <>
      ...
      <main className="bg-gray-800 min-h-screen py-12">
        {user ? <h1 className="text-3xl font-bold mb-4 text-white">HI {user.username}</h1> : <div>Loading data</div>}
        <Exercises has_program={program.data ? (!program.data.error) : false} program={program.data ? program.data.data : {}} />
      </main>
    </>
  );
}
